var layoutTemplate = require('../view/layout.html'),
	...
	reportesControlSicapTemplate = require('../view/Reports/ControlSicap/reportes.html'),
...
function routing($stateProvider, $urlRouterProvider) {
	...
	$stateProvider.state('controlsicap_reports', {
		parent: 'main',
		url: '/controlsicap/reportes',
		controller: 'ReportesControlSicapController',
		controllerAs: 'reportesController',
		template: reportesControlSicapTemplate
	});
}
