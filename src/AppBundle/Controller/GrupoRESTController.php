 ...
 * @RouteResource("Grupo")
 */
class GrupoRESTController extends VoryxController
{
    /**
     * Get a Grupo entity.
     *
     ...
     * @return Response
     */
    public function getAction(Grupo $entity)
    {
        return $entity;
    }
    /**
     * Get all Grupo entities.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher, Request $request)
    {
        try {
            ...
            $entity = $em->getRepository('AppBundle:Grupo');
    ...
    {
        $entity = new Grupo();
        $form = $this->createForm(new GrupoType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Grupo $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Grupo entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Grupo $entity)
    {
        return $this->putAction($request, $entity);
    }
    /**
     * Delete a Grupo entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Grupo $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
