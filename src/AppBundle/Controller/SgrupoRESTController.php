 ...
 * Sgrupo controller.
 *
 * @RouteResource("Sgrupo")
 */
class SgrupoRESTController extends VoryxController
{
    /**
     * Get a Sgrupo entity.
     *
     ...
     * @return Response
     */
    public function getAction(Sgrupo $entity)
    {
        return $entity;
    }
    /**
     * Get all Sgrupo entities.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher, Request $request)
    {
        try {
            ...
            $entity = $em->getRepository('AppBundle:Sgrupo');
    ...
    {
        $entity = new Sgrupo();
        $form = $this->createForm(new SgrupoType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Sgrupo $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Sgrupo entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Sgrupo $entity)
    {
        return $this->putAction($request, $entity);
    }
    /**
     * Delete a Sgrupo entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Sgrupo $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
